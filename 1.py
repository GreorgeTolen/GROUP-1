...
class BlockchainExplorer:
    ...
    def show_gui(self):
        ...
        # Create Treeview to display the blockchain
        ...
        for block in self.blockchain.chain:
            ...
            tree.insert("", "end", values=(block.hash, time.ctime(block.timestamp), block.data, validation))
...
if __name__ == "__main__":
    ...
    # Open the Blockchain Explorer GUI
